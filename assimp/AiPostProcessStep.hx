...
@:enum abstract AiPostProcessStep(Int) from Int to Int {
    ...
    var PreTransformVertices = (0x100);
    ...
    var ValidateDataStructure = (0x400);
    ...
    var ImproveCacheLocality = (0x800);
     ...
     * importer property.     */
    var RemoveRedundantMaterials = (0x1000);
     ...
     *  qualify for removal.     */
    var aiProcess_Debone = (0x4000000);
     ...
     */
    var TargetRealtime_Fast = (CalcTangentSpace | GenNormals | JoinIdenticalVertices | Triangulate | GenUVCoords | SortByPType);
     ...
     */
    var TargetRealtime_Quality = (CalcTangentSpace | GenSmoothNormals | JoinIdenticalVertices | ImproveCacheLocality | LimitBoneWeights
    | RemoveRedundantMaterials | SplitLargeMeshes | Triangulate | GenUVCoords | SortByPType | FindDegenerates | FindInvalidData);
